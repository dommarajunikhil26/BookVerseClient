...
const BooksAvailable = () => {
    ...
    return (
        <div className="w-[90%] md:w-1/4 h-[300px] border-2 drop-shadow-2xl flex flex-col items-center">
            <div className="w-[90%] border-b-[1px] pt-2">
                <p>0/5 books checked out</p>
            </div>
            <div className="flex flex-col border-b-[1px] w-[90%]">
                <p className="text-green-700">Available</p>
                <div className="flex flex-row justify-between">
                    <p className="mr-4">10 copies</p>
                    <p>10 available</p>
                </div>
            ...
            <div className="w-[90%]">
                <p>The number can change until placing order has been complete.</p>
                <p className="pt-4">Sign in to be able to leave a review</p>
            </div>
        </div>
    )
}
